...
// const fontPath = path.join('C:/Users/HP/Documents/NodeJsProjects/english_sikho09/font/', 'TiroDevanagariHindi-Regular.ttf');
// registerFont(fontPath, { family: 'Tiro Devanagari Hindi' });
// const fontPath = path.join('C:/Users/HP/Documents/NodeJsProjects/english_sikho09/font/', 'Sura-Regular.ttf');
// registerFont(fontPath, { family: 'Sura' });
const fontPath = path.join('C:/Users/HP/Documents/NodeJsProjects/english_sikho09/font/', 'Sura-Bold.ttf');
registerFont(fontPath, { family: 'Sura' });
...
export default async function putSinglePhraseOnPhoto(inputImage, englishText, hindiText, outputPath, height, width) {
  ...
  try {
    ...
    // Load the card image
    const cardImgPath = 'C:/Users/HP/Documents/NodeJsProjects/english_sikho09/utils/card.png';
